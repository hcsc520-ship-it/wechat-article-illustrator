...
/wechat-article-illustrator path/to/article.md

# Specify type
/wechat-article-illustrator path/to/article.md --type infographic

# Specify style
/wechat-article-illustrator path/to/article.md --style blueprint

# Combine type and style
/wechat-article-illustrator path/to/article.md --type flowchart --style notion

# Specify density
/wechat-article-illustrator path/to/article.md --density rich

# Generate up to 4 images in parallel after prompts are saved
/wechat-article-illustrator path/to/article.md --batch-size 4
...
```bash
/wechat-article-illustrator api-design.md --type infographic --style blueprint
```

**Same thing with preset**:
```bash
/wechat-article-illustrator api-design.md --preset tech-explainer
```

**Personal story**:
```bash
/wechat-article-illustrator journey.md --preset storytelling
```

**Tutorial with steps**:
```bash
/wechat-article-illustrator how-to-deploy.md --preset tutorial --density rich
```

**Opinion article with poster style**:
```bash
/wechat-article-illustrator opinion.md --preset opinion-piece
```

**Preset with override**:
```bash
/wechat-article-illustrator article.md --preset tech-explainer --style notion
```
