...
description: First-time setup flow for the standalone WeChat article illustrator preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.baoyu-skills/wechat-article-illustrator/EXTEND.md` | Current project |
| User | `~/.baoyu-skills/wechat-article-illustrator/EXTEND.md` | All projects |
